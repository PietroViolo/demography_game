...
def game_loop():
    ...
    draw_text("Quel pays est le plus peuplé?", 600, 150) 
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_LEFT:
                    if flags[0]["population"] == highest_population:
                        ...
                        draw_text("Vrai! Sa population est de " + str(flags[0]["population"]), 500, 500)
                        ...
                        draw_text("Faux! La bonne réponse est:", 500, 400)
                        flag_x = pygame.image.load(flags_dir +highest_iso+ ".png")
                        screen.blit(flag_x, (1600, 400))
                        pygame.display.update()
                        pygame.time.wait(5000)                
                        screen.fill((82, 138, 235)) # blue
                        counter = 0
                    ...
                    if flags[1]["population"] == highest_population:
                        screen.fill((0, 255, 0)) # green
                        draw_text("Vrai! Sa population est de " + str(flags[1]["population"]), 500, 500)
                        pygame.display.update()
                        pygame.time.wait(5000)                
                        screen.fill((82, 138, 235)) # blue
                        counter += 1
                    ...
                    if flags[2]["population"] == highest_population:
                        screen.fill((0, 255, 0)) # green
                        draw_text("Vrai! Sa population est de " + str(flags[2]["population"]), 500, 500)
                        pygame.display.update()
                        pygame.time.wait(5000)                
                        screen.fill((82, 138, 235)) # blue
                        counter += 1
